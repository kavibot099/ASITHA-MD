...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=L34TwBZY#wbdu96WXYS_h_PQCauZSylHYnXzk9wItP6n4O5A7z6U' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '9473737373,9363636367' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "asitha" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello ,මම ඔන්ලයින් බන්*" : process.env.ALIVE_MSG,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '94721407849' : process.env.DELETEMSGSENDTO,
